...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.parent'
        db.add_column('teams_team', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.parent'
        db.delete_column('teams_team', 'parent_id')
    ...
    models = {
        ...
        'teams.team': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']", 'null': 'True'}),
