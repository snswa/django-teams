...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupingTeam'
        db.create_table('teams_groupingteam', (
        ...
        db.send_create_signal('teams', ['GroupingTeam'])

        # Deleting field 'Grouping.inline_ordering_position'
        db.delete_column('teams_grouping', 'inline_ordering_position')
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GroupingTeam'
        db.delete_table('teams_groupingteam')

        # Adding field 'Grouping.inline_ordering_position'
        db.add_column('teams_grouping', 'inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
